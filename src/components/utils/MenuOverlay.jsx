...
import LanguajeMenu from './LanguajeMenu';

const MenuOverlay = ({ links, onClose, changeLanguage }) => {
    return (
        <div className='flex justify-center items-center'>
            <ul className='flex py-4 items-end gap-6 pr-10'>
            ...
            <div className='flex gap-2'>
                ...
                <a href='#' target='_blank' className='w-6 h-6 group' >
